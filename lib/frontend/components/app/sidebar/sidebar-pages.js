...
const SidebarPages = props => {
  ...
  const pages = pagesOriginal === null || pagesOriginal === void 0 ? void 0 : pagesOriginal.filter(page => page.isVisible || page.isVisible == undefined);
  const {
    translateLabel
...
var _default = exports.default = SidebarPages;