...
class AdminJS {
  ...
  initI18n() {
    var _this$options$localeL, _this$options$localeL2;
    console.log('run initI18n');
    this.locale = {
      translations: (0, _config.combineTranslations)(_en.default.translations, (_this$options$localeL = this.options.localeList) === null || _this$options$localeL === void 0 ? void 0 : _this$options$localeL['en'].translations),
      language: ((_this$options$localeL2 = this.options.localeList) === null || _this$options$localeL2 === void 0 ? void 0 : _this$options$localeL2['en'].language) || _en.default.language
    };
